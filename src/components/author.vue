 ...
 <section class="container">
      <div class="col-12">
          <div class="form-group row">
              <div class="col-8">
                  <input type="text" @keyup.enter="getLibros" class="form-control" placeholder="Nombre del Autor" v-model="author" > 
              </div>
...
export default {
  ...
  methods:{
      getLibros(){
          const t = this;
            let url = 'http://www.etnassoft.com/api/v1/get/?book_author="'+this.author+'"';
